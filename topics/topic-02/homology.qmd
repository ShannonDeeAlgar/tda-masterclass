...
![Classical spaces with different numbers of components, loops and enclosures.](../../assets/topic02-classic-homology-v2.svg){fig-alt="Two separated components, a circle, a sphere surface and a torus surface. The two independent loop directions on the torus are shown in different colours. Each object is labelled with its first three Betti numbers."}
