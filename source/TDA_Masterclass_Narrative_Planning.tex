...
\begin{center}
    ...
    \textit{Foundations, filtrations and method choice for applied dynamical systems}
\end{center}
...
\weekheading{2}{Simplicial complexes and homology: building a computable hole-counter}
...
\weekheading{3}{Filtrations: setting the complex in motion}
...
\weekheading{4}{Persistent homology: homology with memory}
...
\weekheading{5}{Static data in practice: choosing and computing filtered complexes}
...
\weekheading{7}{Time-indexed static topology: repeated persistence through time}
...
\weekheading{8}{Beyond ordinary persistence: which advanced tool solves which problem?}
